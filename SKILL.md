...
- 📋 **质量检查清单** - 发布前自动验证
- 🛡️ **环境预检查** - 减少运行时错误
- ⏰ **双触发定时** - GitHub Actions + Cloudflare Workers 双保险
...
### v4.1.0 (2026-03-08)
- 🔧 **财经源强化**：新增 3 个中文财经源（财联社/财新网/金十数据），替换失效国际源
- 🔄 **RSSHub 多实例 fallback**：每个中文财经源配 3 个备选镜像
- 🤖 **分类补救机制**：分类不足 3 条时自动从未分类池补充
- 🎯 **分类提示词优化**：汽车/供应链等边界案例准确分类

### v4.0.0 (2026-03-07)
- 🚀 **纯 RSS 重构**：48 个源大扩展，100% 真实新闻
- ⏰ **双触发定时**：GitHub Actions + Cloudflare Workers
- 🐛 **时区 Bug 修复**：解决 0 条新闻的根因
